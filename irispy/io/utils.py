...
def read_files(filenames, *, spectral_windows=None, uncertainty=False, memmap=False, allow_errors=False, **kwargs):
    ...
    memmap : `bool`, optional
        ...
        .. note::
            Scaling behaviour differs by reader. The raster (spectrograph) reader
            applies BSCALE/BZERO scaling on first access and returns data in
            calibrated DN units. The SJI reader returns raw unscaled integer DN.
            In both cases a lazy bad-pixel mask is provided.
