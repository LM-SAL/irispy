...
There are two examples, one showcases how to remove spikes from IRIS spectrogram data: :ref:`sphx_glr_generated_gallery_calibration_01_remove_spikes_sg.py` and :ref:`sphx_glr_generated_gallery_calibration_02_remove_spikes_sji.py` details how to remove spikes from IRIS SJI data.
