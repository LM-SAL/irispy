...
iris_observer = wcs_to_celestial_frame(first_raster.wcs.celestial).observer
iris_frame = Helioprojective(observer=iris_observer)
lower_corner = [None, SkyCoord(-908 * u.arcsec, 311 * u.arcsec, frame=iris_frame), None, None]

mg_ii_k_unflipped_spectra = first_raster_unflipped.crop(lower_corner, lower_corner)
mg_ii_k_spectra = first_raster.crop(lower_corner, lower_corner)
