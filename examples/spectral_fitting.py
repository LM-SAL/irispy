...
################################################################################
# The function `~astropy.modeling.fitting.parallel_fit_dask` will map a model to each elemen
# t of a cube along
...
# `~astropy.modelling.parallel_fit_dask`, these warnings/exceptions are caught and not raised.
